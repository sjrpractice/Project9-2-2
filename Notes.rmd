...
data(ToothGrowth)
?ToothGrowth
plot_ly(ToothGrowth, x= ~len, y= ~supp, mode="scatter")
```
...
```{r, eval=FALSE}
plot_ly(ToothGrowth, xmode = "markers", color = as.factor(cyl))
```

## Scatterplot Color

```{r, echo=FALSE, message=FALSE}
plot_ly(ToothGrowth, x = ~len, y = ~dose, mode = "markers", color = as.factor(cyl))
```
